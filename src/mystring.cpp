...
//        size_t tmp_n = *n;
//
//        while (curr_n > 1 && (c = getc(stream)) != EOF && c != '\n' ) //читаем, оставляя 1 доступный блок памяти
//        {
//            *(curr_line_char++) = (char) c;
//
//            //printf("%d %c\n", curr_n, c);
//
//            read_bytes++;
...
//        {
//            //printf("???\n");
//            //если не хватило нынешней памяти
//
//            *curr_line_char = '\0'; //превращаем то, что уже прочитали, в строку
//
//            *n = MEM_MULTIPLIER * (*n);
//
//            char *old_line = *lineptr;
//
//            new_line = (char *) calloc( *n, sizeof(char) );
//
//            if (new_line == NULL) return -1;
//
//            my_strcpy( new_line, *lineptr );
//
//            free(old_line);
//
//            *lineptr = new_line;
//
//            curr_line_char = *lineptr + tmp_n - 1;
//
//            //нужно один символ прочитать вручную
//            c = getc(stream);
//            read_bytes+=1;
//            if (c == '\n')
//            {
...
//
//            *(curr_line_char++) = (char) c;
//            *(curr_line_char) = '\0'; //maybe unnecessary
//
//            curr_n = tmp_n;
//        }
//        else if (curr_n > 1 && c == '\n')
